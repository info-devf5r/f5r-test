...
<?php
 ...
 $url_arr = explode('?user=',$url);
 $url_arr_user_name = explode('&name=',$url_arr[1]);
 $url_arr_user_id = explode('&name=',$url_arr[1]);

$user_id = $url_arr_user_id[0];
$user_name = $url_arr_user_name[1];
...
<body>
		...
		<h1 class="text-center" ><?php echo $user_name ?> Videos</h1>

		<div id="userVideo">
		<div class='row justify-content-center'>
		<?php
		$videos = getAllUserVideos($user_id);
		getVideosTemplate($videos, 'userVideo');
		?>
		</div>
		</div>

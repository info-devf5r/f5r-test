...
<?php
 ...
 if(isset($_SESSION['all-videos'])){
	$all_search_videos = $_SESSION['all-videos'];
...
<body>
		...
		<h1 class="text-center" >Video Search</h1>

		<div id="searchVideo" class='container-fluid'>
		<div class='row justify-content-center'>
		<?php
		getVideosTemplate($all_search_videos, 'searchVideo');
		?>
		</div>
		</div>

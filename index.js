...
/////////////////
const BotName = 'LeviBOT☄'; 
const instagram = 'https://instagram.com/levyyy.i'; 
const telegram = 'No have'; 
const kapanbotaktif = 'KETIKA HANYA DIAKTIFKAN'; 
const youtube = 'No have';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@levyyy.i')

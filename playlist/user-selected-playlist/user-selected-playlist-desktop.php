...
?>
	...
	<div class="container-fluid mt-3">
		<div class="row" id="selectedPlaylistRow">
				<!-- desktop -->
			<div class="col-7 " id="playlistVideoSelectedDeskTop">
				<?php
				getVideoTemplate($playlist_video_selected, 'playlistVideoSelectedDeskTop', true);				?>
			</div>

			<div class="col-5 " id="playlistVideos">
				<?php
				echo "
				<div>
				";
